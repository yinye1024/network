...
%%%-------------------------------------------------------------------
-module(yynw_test_httpd_bs_handler).
-author("yinye").
...
priv_handle('GET',Req,_BsPathList)->
  ...
  ?LOG_INFO({get,Qs}),
  {?OK, yynw_test_resp_restful:new_success_tjson(?NOT_SET)};
